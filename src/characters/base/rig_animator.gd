...
static func _all() -> Array:
	return [
		...
		# GARD DURUSU: yumruklar gogus hizasinda, dirsekler ~90 derece,
		# hicbir kol govde orta hattini GECMEZ. Bacaklar omuz genisliginde
		# ve hafif makas - "hazirolda asker" degil, dovuscu.
		[&"idle", _make(2.0, true, {
			TORSO: [[0.0, -5.0], [1.0, -7.5], [2.0, -5.0]],
			HEAD: [[0.0, 2.0], [1.0, 4.0], [2.0, 2.0]],
			AFU: [[0.0, -32.0], [1.0, -28.0], [2.0, -32.0]],
			AFL: [[0.0, -92.0], [1.0, -96.0], [2.0, -92.0]],
			ABU: [[0.0, -22.0], [1.0, -19.0], [2.0, -22.0]],
			ABL: [[0.0, -104.0], [1.0, -108.0], [2.0, -104.0]],
			LFU: [[0.0, -19.0], [1.0, -18.0], [2.0, -19.0]],
			LFL: [[0.0, 16.0], [1.0, 15.0], [2.0, 16.0]],
			LBU: [[0.0, 23.0], [1.0, 22.0], [2.0, 23.0]],
			LBL: [[0.0, -14.0], [1.0, -13.0], [2.0, -14.0]],
		...
		[&"run", _make(0.5, true, {
			...
			AFU: [[0.0, -22.0], [0.25, -52.0], [0.5, -22.0]],
			AFL: [[0.0, -95.0], [0.25, -78.0], [0.5, -95.0]],
			ABU: [[0.0, -46.0], [0.25, -18.0], [0.5, -46.0]],
			ABL: [[0.0, -82.0], [0.25, -104.0], [0.5, -82.0]],
